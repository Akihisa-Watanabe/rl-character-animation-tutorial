...
class MujocoEnv(base_env.BaseEnv):
    def __init__(self, config: dict, device: torch.device, visualize: bool) -> None:
        ...
        self._device = device
        self._env = self._build_mujoco_env(config, visualize)
        self.reset()
    ...
    def _build_mujoco_env(self, config: dict, visualize: bool) -> gym.Env:
        """
        ...
        assert env_name.startswith("mujoco_"), "Invalid environment name"
