...
def train(agent, max_samples, out_model_file, int_output_dir, log_file):
    agent.train_model(max_samples=max_samples, out_model_file=out_model_file, int_output_dir=int_output_dir, log_file=log_file)
    return
...
def main(argv):
    ...
    if mode == "train":
        ...
        train(agent=agent, max_samples=max_samples, out_model_file=out_model_file, int_output_dir=int_output_dir, log_file=log_file)
    elif mode == "test":
